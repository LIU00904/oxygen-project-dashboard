window.FEISHU_PROJECTS = [
  ...
  },
  {
    ...
    "monitorLinks": [],
    "kpiStatus": "部分未达标",
    "currentData": "正式发稿附表已读取：有效发布链接 89 条。\n发稿 KPI：89/100 篇，还差 11 篇；以新飞书附表为准，之前本地周报统计口径已废弃。\n亚洲龙 6/7 KPI 表：6 个基础词的 SOV、Top3、Top10 综合值均达标；最新综合 SOV 20.6%-27.7%、Top3 57.0%-68.9%、Top10 82.7%-89.3%。\n荣放 5/20 点检表：Top3 38.51% 已超过 ≥20%；SOV 7.63% 距 ≥15% 还差 7.37 个百分点；Top10 47.24% 距 ≥80% 还差 32.76 个百分点。",
    "optimizationSuggestion": "先补齐正式发稿附表中的 11 篇发布缺口；荣放侧继续重点补 SOV 与 Top10，增加汽车垂媒/问答信源覆盖，围绕“15万左右通勤SUV、城市SUV、家用SUV”等词做定向发布和监测复盘。",
    "reportLinks": [
      {
...
window.FEISHU_SYNC_META = {
  ...
  "source": "feishu",
  "recordCount": 49,
  "note": "main-table-sync-v21-analysis-refresh",
  "preservedAnalysis": [
    "太太乐松茸鲜",
    "华硕",
    "一丰 荣放 亚洲龙"
  ],
  "analysisUpdatedAt": "2026-06-11T07:41:08.202Z"
};
