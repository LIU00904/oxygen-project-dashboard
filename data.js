window.FEISHU_PROJECTS = [
  ...
  },
  {
    ...
    "monitorLinks": [],
    "kpiStatus": "发稿已达标，监测待核验",
    "currentData": "【发稿数据】\n已按发稿记录筛选“已发稿”核对：有效发布链接 123 条。\n发稿 KPI：123/100 篇，已达到数量要求，超出 23 篇。\n【监测数据】\n主表未关联可由当前应用自动读取的监测表，本次先更新发稿数量；亚洲龙、荣放的 SOV、Top3、Top10 趋势仍需接入监测表后复核。",
    "optimizationSuggestion": "发稿数量已达标；下一步重点补齐/接入监测表，复核亚洲龙与荣放的 SOV、Top3、Top10 是否达到各自 KPI。",
    "reportLinks": [
      {
