window.FEISHU_PROJECTS = [
  ...
  },
  {
    ...
    "kpiStatus": "未达标",
    "currentData": "发稿表已按子项目核对：华硕主板 100/150 篇，还差 50 篇；华硕商城 80/150 篇，还差 70 篇。\n两个子项目均要求各 150 篇，不能按主板+商城合并总数判断达标。\n监测表已读取，排名表现整体较稳定：脚本最新抽样识别 Top3/Top10 均为 50/50；保留此前完整监测口径，排名侧主要风险较低。\n当前主要未达标项不是排名，而是主板/商城两个子项目各自的发稿数量。",
    "optimizationSuggestion": "优先补齐发稿缺口：华硕主板补 50 篇、华硕商城补 70 篇；排名侧继续保持监测表按周更新，重点防止“未推荐品牌/推荐其他产品”的少数样本回落。",
    "reportLinks": [
      {
  ...
  },
  {
    ...
    "monitorLinks": [],
    "kpiStatus": "部分未达标",
    "currentData": "正式发稿附表已重新核对：有效发稿条目 103 条。\n发稿 KPI：103/100 篇，已达到数量要求；此前 89 是按唯一链接数低估。\n亚洲龙 6/7 KPI 表：6 个基础词的 SOV、Top3、Top10 综合值均达标；最新综合 SOV 20.6%-27.7%、Top3 57.0%-68.9%、Top10 82.7%-89.3%。\n荣放 5/20 点检表：Top3 38.51% 已超过 ≥20%；SOV 7.63% 距 ≥15% 还差 7.37 个百分点；Top10 47.24% 距 ≥80% 还差 32.76 个百分点。",
    "optimizationSuggestion": "发稿数量已达 103/100；下一步重点不在补发稿，而是荣放侧继续补 SOV 与 Top10，增加汽车垂媒/问答信源覆盖，围绕“15万左右通勤SUV、城市SUV、家用SUV”等词做定向发布和监测复盘。",
    "reportLinks": [
      {
