window.FEISHU_PROJECTS = [
  ...
  },
  {
    ...
    "kpiStatus": "未达标",
    "currentData": "发稿表实时核对：华硕商城 86 行有效发稿链接；华硕主板 106 行有效发稿链接；排除拒稿/发布中/空白 0 行。\n发稿 KPI：华硕主板 106/150 篇，还差 44 篇；华硕商城 86/150 篇，还差 64 篇。\n两个子项目均要求各 150 篇，不能按主板+商城合并总数判断达标。\n补充说明：表中存在 3 个重复 URL，但对应不同标题/发稿行；按发稿量以有效发稿行数计，不按唯一 URL 去重。\n监测表已读取，排名表现整体较稳定：脚本最新抽样识别 Top3/Top10 均为 50/50；当前主要未达标项是主板/商城两个子项目各自的发稿数量。",
  ...
  },
  {
    ...
    "monitorLinks": [],
    "kpiStatus": "未达标",
    "currentData": "发稿链接实时核对：5 行有效发稿链接，排除拒稿/发布中/空白 0 行。\n发稿 KPI：5/20 篇，还差 15 篇。\n尚未关联监测表，暂无法判断收录、目标信源和近一周/近一月趋势。",
  ...
  },
  {
    ...
    "monitorLinks": [],
    "kpiStatus": "已达标",
    "currentData": "发稿表实时核对：56 行有效发稿链接，排除拒稿/发布中/空白 0 行。\n发稿 KPI：56/36 篇，已达到数量要求，超出 20 篇。\n尚未关联监测表，暂无法判断大模型关键词正向提及率是否超过 90%。",
  ...
  },
  {
    ...
    "monitorLinks": [],
    "kpiStatus": "推进中",
    "currentData": "项目已启动，当前尚未关联发稿表和监测表。\n发布 KPI：0/150 篇，还差 150 篇。\n每个平台每月需优化不少于 30 个关键词；月度至少 4 个平台稳定保持第二并占据第一梯队。\n核心优势信息准确率目标 95% 以上；月度关键词达标率目标 80%。\n待补充发稿链接、监测表和报告文件后，才能更新真实发布量、排名与达标率。",
