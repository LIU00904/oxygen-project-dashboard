(() => {
  ...
  "数贸会": {
    "status": "进行中",
    "kpiStatus": "推进中",
    "currentData": "【发稿数据】\n有效发稿 312 篇；KPI 未写明固定发稿数量，当前只记录发布量。\n【监测数据】\n收录/提及相关记录：正向 1 条，未收录 0 条。",
    "optimizationSuggestion": "继续保持发稿表和监测表按周更新，并在月末归档报告。"
  }
};
  ...
  window.FEISHU_SYNC_META = {
    ...(window.FEISHU_SYNC_META || {}),
    ...{
  "analysisUpdatedAt": "2026-07-02T02:35:45.291Z",
  "yifengPublishUpdatedAt": "2026-07-02T02:35:45.295Z",
  "hotfixUpdatedAt": "2026-07-02T03:09:19.531Z",
  "hotfixNote": "ongoing-publish-monitor-refresh-20260702"
}
  };
})();
